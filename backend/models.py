...
class User(Base):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime, default=_now_bjt, nullable=False)
...
class ChatSession(Base):
    ...
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=_now_bjt, nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=_now_bjt, nullable=False)
...
class ChatMessage(Base):
    ...
    timestamp: Mapped[datetime] = mapped_column(DateTime, default=_now_bjt, nullable=False)
