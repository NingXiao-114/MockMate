...
from milvus_client import MilvusManager , milvus_manager as _default_milvus_manager
...
class MilvusWriter:
    ...
    def write_documents(self, documents: list[dict], batch_size: int = 50, progress_callback=None):
        ...
        self.embedding_service.increment_add_document(all_texts)
